...
public class SFDICreator implements InstitutionCreator {
    @Override
...
//                json.put("amountCzk", rs.getString("amount_czk"));
    ...
    public String getQuery() {
        return "select master_id, " +
                ...
                "where authority = (select entity_id from entity as en where en.name like 'Státní fond dopravní indfrastruktury') " +
