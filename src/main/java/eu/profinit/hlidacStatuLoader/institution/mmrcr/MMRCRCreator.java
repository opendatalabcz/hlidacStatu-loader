package eu.profinit.hlidacStatuLoader.institution.mmrcr;
...
public class MMRCRCreator implements InstitutionCreator {
    @Override
...
//                json.put("amountCzk", rs.getString("amount_czk"));
    ...
    public String getQuery() {
        return "select master_id, " +
                ...
                "where authority = (select entity_id from entity as en where en.name like 'Ministerstvo pro místní rozvoj') " +
                "and record_type in ('invoice', 'payment');";
    }

    @Override
    public String getDatasetId() {
        return "faktury-mmrcr";
    }
}
