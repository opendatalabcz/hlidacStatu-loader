package eu.profinit.hlidacStatuLoader.institution.mfcr;
...
public class MFCRCreator implements InstitutionCreator {
...
//                json.put("amountCzk", rs.getString("amount_czk"));
    ...
    public String getQuery() {
        ...
        "where authority = (select entity_id from entity as en where en.name like 'Ministerstvo financí ČR') " +
